...
var playGame = function() {
	...
	var p2 = new points(300, "JONA",830,350,"AldeanoAzul",5);
	var p3 = new points(500, "MORATA",830,400,"AldeanoRojo",5);
...
var points = function(number,name,x,y,sprite,aldes){
	...
	this.draw = function(ctx) {
		...
		ctx.fillStyle = "#000000";
		ctx.font = "20px Verdana";
		ctx.fillText(aldes,x+180,y);
		SpriteSheet.draw(Game.ctx,sprite,x+200,y-20,0,true);
    };
